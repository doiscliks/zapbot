      ...
      {!loading && !erro && (
        <div className="space-y-6">
          ...
          {(() => {
            ...
            return (
              <div className="rounded-2xl px-6 py-4 flex items-center gap-8 animate-fade-in-up" style={cardStyle}>
                <div>
                ...
                <div className="relative shrink-0">
                  <svg width="88" height="88" viewBox="0 0 88 88">
                    <circle cx="44" cy="44" r={r} fill="none" stroke="#E9EEF2" strokeWidth="10" />
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-lg font-bold" style={{ color: '#1F2937' }}>{taxa}%</span>
                  </div>
                </div>
